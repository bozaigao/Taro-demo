...
const RefreshProvider_1 = __importDefault(require("./RefreshProvider"));
const utils_1 = require("./utils");
const queryString = require('query-string');
class TaroProvider extends react_1.default.Component {
    constructor(props, context) {
        super(props, context);
        this.refreshProviderRef = react_1.default.createRef();
    }
    ...
    setTabBarItem(options = {}) {
        ...
        try {
            ...
            _taroTabBarIconConfig[index] = Object.assign({}, _taroTabBarIconConfig[index], { itemText: text, itemSelectedIconPath: selectedIconPath, itemIconPath: iconPath });
            ...
            console.log(e);
            return utils_1.errorHandler(fail, complete)(res);
        }
        return utils_1.successHandler(success, complete)(res);
    }
    /**
    ...
    showTabBar(options = {}) {
        ...
        if (options.hasOwnProperty('animation') && typeof animation !== 'boolean') {
            res.errMsg = utils_1.getParameterError({
                name: 'showTabBar',
                para: 'animation',
                correct: 'Boolean',
                wrong: animation
    ...
    render() {
        return (react_1.default.createElement(RefreshProvider_1.default, Object.assign({ ref: this.refreshProviderRef }, this.props), this.props.children));
    }
}
