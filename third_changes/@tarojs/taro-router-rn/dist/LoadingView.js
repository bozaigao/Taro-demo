...
class LoadingView extends react_1.default.Component {
    constructor(props) {
        super(props);
        this.state = {
            rotateValue: new react_native_1.Animated.Value(0) // 初始值
        };
    }
    startAnimation() {
        this.state.rotateValue.setValue(0);
        react_native_1.Animated.timing(this.state.rotateValue, {
            toValue: 1,
            duration: 2000,
