            ...
            <View style={styleAssign([w(291), h(150)])}>
              <Image style={styleAssign([styles.upa, absT(0), absL(0), wRatio(100), hRatio(100)])}
                ...
                <View style={styleAssign([styles.uf1, styles.uac, pt(40)])}>
                  ...
                  <Text
                    style={styleAssign([fSize(20), color(commonStyles.whiteColor), bgColor(commonStyles.transparent), mt(27),
                      fWeight('bold')])}
                  >
                    {signInPageDetail.canSignIn ? '未签到' : '签到成功'}
                  </Text>
                  <Text style={styleAssign([fSize(14), mt(4), color(commonStyles.whiteColor),
            ...
            <View style={styleAssign([styles.uac, mt(10), mb(20)])}>
              {
                ...
                <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}}
                                colors={['#ff9200', '#ff5f00']}
                  //@ts-ignore
                                style={styleAssign([w(201), h(45), radiusA(4)])}>
                  <TouchableButton
                    customStyle={styleAssign([styles.uf1, styles.uac, styles.ujc])}
                    onClick={() => {
