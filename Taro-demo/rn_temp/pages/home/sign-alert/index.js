...
import { absL, absT, bgColor, color, commonStyles, default as styles, fSize, fWeight, h, hRatio, mb, ml, mt, pl, pt, radiusA, w, wRatio } from "../../../utils/style";
        ...
        <View style={styleAssign([w(291)])}>
          <View style={styleAssign([bgColor(commonStyles.whiteColor), radiusA(4), { overflow: 'hidden' }])}>
            <View style={styleAssign([w(291), h(150)])}>
              <View style={styleAssign([w(291), h(150)])}>
                <Image style={styleAssign([styles.upa, absT(0), absL(0), wRatio(100), hRatio(100)])} src={icoQiandaoBg} />
                <View style={styleAssign([styles.uf1, styles.uac, pt(35)])}>
                  ...
                  <Text style={styleAssign([fSize(20), color(commonStyles.whiteColor), bgColor(commonStyles.transparent), mt(20), fWeight('bold')])}>
                    {signInPageDetail.canSignIn ? '未签到' : '签到成功'}
                  </Text>
                  <Text style={styleAssign([fSize(14), mt(2), color(commonStyles.whiteColor), bgColor(commonStyles.transparent)])}>
            ...
            <View style={styleAssign([styles.uac, mt(10), mb(20)])}>
              <TouchableButton customStyle={styleAssign([styles.uac, styles.ujc, bgColor('#ff5f00'), w(201), h(45)])} onClick={() => {
