...
let HomeSearchTop = class HomeSearchTop extends PureComponent {
  render() {
    ...
    return <View style={styleAssign([styles.uac, styles.udr, wRatio(100)])}>
        
        <View style={styleAssign([bgColor(commonStyles.whiteColor), wRatio(10), h(50), styles.uac, styles.ujc])} onClick={() => {
        ...
        // navigation.navigate('MessagePage')
          ...
          <View style={styleAssign([styles.uac, styles.ujc, w(25), h(25)])}>
            ...
            <View style={styleAssign([bgColor('#ec1313'), w(6), h(6), radiusA(3), styles.upa, absT(0), absR(0)])} />
          </View>
        </View>
        
        <View style={styleAssign([wRatio(80), h(52), styles.uac, styles.ujc])}>
          <TouchableButton customStyle={styleAssign([wRatio(100), h(52)])} onClick={() => {
          console.log('SearchPage');
          // navigation.navigate('SearchPage')
        }}>
            <Image mode="scaleToFill" src={searTopBg} style={styleAssign([wRatio(100), h(52)])} />
          </TouchableButton>
        ...
        <View style={styleAssign([wRatio(10), h(50), styles.uac, styles.ujc])} onClick={() => {
