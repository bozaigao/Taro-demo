...
const my_modal_1 = require("../my-modal");
class Loading extends taro_1.Component {
    render() {
        return (<my_modal_1.default>
        <components_1.View style={datatool_1.styleAssign([style_1.default.uac, style_1.default.ujc, style_1.default.upa, style_1.zIndex(1000), style_1.absL(0), style_1.absB(0), style_1.absR(0), style_1.absT(0),
